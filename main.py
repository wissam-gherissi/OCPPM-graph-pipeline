...
if __name__ == '__main__':
    ...
    names_ot_dict = {"recruiting-ocel1":['applicants', 'applications', 'offers'],
                     ...
                     "socel2_hinge": ['SteelSheet','FormedPart','FemalePart','MalePart','SteelPin','Hinge','HingePack'],
                     "ocel2-p2p": ['material','purchase_requisition','quotation','purchase_order','goods_receipt','invoice_receipt','payment']
                     }
    ...
    g_funcs = [num_unique_acts, num_events, num_objects]
    # Set this value to:
